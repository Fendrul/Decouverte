...
public class problem8 {
    public static void main(String[] args) {
        ...
        int greatestProduct = tableauNombre.findGreatestProduct(13);
    ...
    private static class TableauNombre {
        ...
        public static int findGreatestProductInList(List<Integer> list, int quantiteNombresAdjacents) {
            int result = 0;
            int calc = 0;
        ...
        private static <T> int ProductFromArray(T[] toArray) {
            List<Integer> list = Arrays.stream(toArray)
